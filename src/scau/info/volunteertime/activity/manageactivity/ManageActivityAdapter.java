...
public class ManageActivityAdapter extends BaseAdapter {
	...
	private OnSendMessageButtonListener sendMessageButtonListener;

	String userId;

	public ManageActivityAdapter(Context context,
			LinkedList<ActivityDate> linkedList) {
		super();
		...
		if (activityCenter.getActivityGroup().getPrincipalId().trim()
			...
			holder.participate.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					String text = (String) ((Button) v).getText();
					Log.d("getView-setOnClickListener", "text = " + text);
					sendMessageButtonListener.onSendMessage(
							activityCenter.getActivityGroup(),
							activityCenter.getTitle());
				}
			});
		}
	...
	public void setSendMessageButtonListener(
			OnSendMessageButtonListener listener) {
		this.sendMessageButtonListener = listener;
	};
	...
	public interface OnSendMessageButtonListener {

		public void onSendMessage(ActivityGroup activityGroup, String title);
