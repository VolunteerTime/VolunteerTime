 ...
 * 
 */
public class PopupMainMenu extends PopupWindow {
	...
	public PopupMainMenu(Context context, int width, int height) {
	...
	public void addActionItems(ArrayList<ActionItem> actionItems) {
		if (actionItems != null) {
